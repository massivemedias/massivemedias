...
const siteContentSeedData = {
  ...
  homeSeo: {
    ...
    descriptionFr: 'Impression fine art, stickers custom, sublimation, design graphique et développement web à Montréal. Service local depuis 2022.',
    descriptionEn: 'Fine art printing, custom stickers, sublimation, graphic design and web development in Montreal. Local service since 2022.',
  },
  ...
  stats: [
    { value: '2022', suffix: '', labelFr: 'Depuis', labelEn: 'Since', isCounter: true },
  ...
  aboutTextFr: "Massive Medias est un studio de production créative actif depuis 2022 et établi dans le Mile-End, au cœur de l'écosystème artistique montréalais.\nL'entreprise offre quatre services intégrés destinés aux artistes visuels, photographes, musiciens et créateurs indépendants : impressions fine art, stickers personnalisés, design graphique et développement web.\nNotre philosophie : offrir un service local, personnalisé et de qualité professionnelle, sans les délais et les complications des services en ligne. Pas de shipping, pas d'attente. Pick-up au Mile-End ou livraison locale.",
  aboutTextEn: "Massive Medias is a creative production studio active since 2022 and based in Mile-End, at the heart of Montreal's artistic ecosystem.\nThe company offers four integrated services for visual artists, photographers, musicians and independent creators: fine art printing, custom stickers, graphic design and web development.\nOur philosophy: offer local, personalized, professional-quality service without the delays and complications of online services. No shipping, no waiting. Pick-up in Mile-End or local delivery.",
  aboutTimelineTitleFr: 'Notre parcours',
  aboutTimelineTitleEn: 'Our Journey',
  aboutTimeline: [
    { year: '2022', eventFr: 'Lancement de Massive Medias - creation de sites web, design graphique et direction artistique pour entreprises et createurs montrealais.', eventEn: 'Launch of Massive Medias - web development, graphic design and art direction for Montreal businesses and creators.' },
    { year: '2023', eventFr: "Projets d'envergure avec des clients majeurs dont La Presse. Demarrage d'un service de creation pour particuliers.", eventEn: 'Major projects with key clients including La Presse. Launch of creation services for individuals.' },
    { year: '2024', eventFr: "Acquisition d'equipements professionnels d'impression fine art, decoupe et sublimation textile. Le studio devient un one-stop shop creatif.", eventEn: 'Acquisition of professional fine art printing, cutting and textile sublimation equipment. The studio becomes a creative one-stop shop.' },
    { year: '2025', eventFr: 'Enregistrement officiel au REQ. Recentrage sur quatre piliers: prints fine art, stickers custom, design graphique et developpement web.', eventEn: 'Official registration with the REQ. Refocus on four pillars: fine art prints, custom stickers, graphic design and web development.' },
    { year: '2026', eventFr: 'Lancement du Merch-as-a-Service, de la boutique en ligne pour prints, stickers et produits sublimes, et mise en ligne du site massivemedias.com.', eventEn: 'Launch of Merch-as-a-Service, online shop for prints, stickers and sublimation products, and launch of massivemedias.com.' },
  ],
...
const servicePagesSeedData = [
  {
    ...
    comparisonFr: { title: 'Studio vs Musée : quelle série choisir?', headers: ['Critère', 'Série Studio', 'Série Musée'], rows: [['Imprimante','Imprimante 4 encres pigmentées','Imprimante 12 encres pigmentées'],['Encres','4 couleurs pigmentées','12 couleurs pigmentées'],['Gamut couleur','Excellent','Ultra-large (galerie)'],['Longévité','50+ ans','100+ ans (archival)'],['Papier max','A2 (18×24")','A1 (24×36")'],['Idéal pour','Décoration, cadeaux, affiches','Expositions, galeries, collectionneurs'],['Profil ICC','Standard','Sur mesure par tirage']] },
    comparisonEn: { title: 'Studio vs Museum: Which Series to Choose?', headers: ['Criteria', 'Studio Series', 'Museum Series'], rows: [['Printer','4 pigmented ink printer','12 pigmented ink printer'],['Inks','4 pigment inks','12 pigment inks'],['Color gamut','Excellent','Ultra-wide (gallery grade)'],['Longevity','50+ years','100+ years (archival)'],['Max paper size','A2 (18×24")','A1 (24×36")'],['Best for','Decor, gifts, posters','Exhibitions, galleries, collectors'],['ICC Profile','Standard','Custom per print']] },
    pricingFr: { title: 'Tarifs Prints', note: 'Série Studio : bonne qualité pour tout · Série Musée : qualité supérieure pour la photographie et les tirages galerie · Ajouter 30$ pour un cadre noir ou blanc', tables: [{ subtitle: 'Impression Fine Art', headers: ['Format','Série Studio (4 encres pigmentées)','Série Musée (12 encres pigmentées)'], rows: [['A4 (8.5×11")','16$','35$'],['A3 (11×17")','22$','65$'],['A3+ (13×19")','30$','95$'],['A2 (18×24")','42$','125$']] },{ subtitle: 'Flyers & Cartes Postales (A6 / 4"×6")', headers: ['Quantité','Prix total','Prix/unité'], rows: [['50','40$','0,80$'],['100','65$','0,65$'],['150','90$','0,60$'],['250','130$','0,52$'],['500','225$','0,45$']] }] },
    pricingEn: { title: 'Prints Pricing', note: 'Studio Series: great quality for everything · Museum Series: superior quality for photography and gallery prints · Add $30 for a black or white frame', tables: [{ subtitle: 'Fine Art Printing', headers: ['Format','Studio Series (4 pigmented inks)','Museum Series (12 pigmented inks)'], rows: [['A4 (8.5×11")','$16','$35'],['A3 (11×17")','$22','$65'],['A3+ (13×19")','$30','$95'],['A2 (18×24")','$42','$125']] },{ subtitle: 'Flyers & Postcards (A6 / 4"×6")', headers: ['Quantity','Total Price','Price/unit'], rows: [['50','$40','$0.80'],['100','$65','$0.65'],['150','$90','$0.60'],['250','$130','$0.52'],['500','$225','$0.45']] }] },
...
const artistsSeedData = [
  ...
  },
  {
    ...
    prints: [
      ...
      { id: 'psyqu33n-002', titleFr: 'Croire en quelque chose de plus grand', titleEn: 'Believing in Something Greater', image: '/images/prints/Psyqu33n2.webp', limited: false },
      { id: 'psyqu33n-003', titleFr: "L'archetype de la reine - la force d'avancer", titleEn: 'The Queen Archetype - Strength to Move Forward', image: '/images/prints/Psyqu33n3.webp', limited: false },
      { id: 'psyqu33n-004', titleFr: 'La douleur derriere le masque', titleEn: 'The Pain Behind the Mask', image: '/images/prints/Psyqu33n4.webp', limited: false },
      { id: 'psyqu33n-005', titleFr: 'La purge - liberer les emotions stockees', titleEn: 'The Purge - Releasing Stored Emotions', image: '/images/prints/Psyqu33n5.webp', limited: false },
      { id: 'psyqu33n-006', titleFr: 'Le masque de la femme forte', titleEn: 'The Mask of the Strong Woman', image: '/images/prints/Psyqu33n6.webp', limited: false },
      { id: 'psyqu33n-007', titleFr: 'Le Vampire - Recalibrer ses relations', titleEn: 'The Vampire - Recalibrating Relationships', image: '/images/prints/Psyqu33n7.webp', limited: false },
      { id: 'psyqu33n-008', titleFr: 'Nefertiti', titleEn: 'Nefertiti', image: '/images/prints/Psyqu33n8.webp', limited: false },
      { id: 'psyqu33n-009', titleFr: 'Rabbit', titleEn: 'Rabbit', image: '/images/prints/Psyqu33n9.webp', limited: false },
      { id: 'psyqu33n-010', titleFr: 'Renard', titleEn: 'Fox', image: '/images/prints/Psyqu33n10.webp', limited: false },
      { id: 'psyqu33n-011', titleFr: 'The Rebirth', titleEn: 'The Rebirth', image: '/images/prints/Psyqu33n11.webp', limited: false },
      { id: 'psyqu33n-012', titleFr: 'Trouver le divin en soi', titleEn: 'Finding the Divine Within', image: '/images/prints/Psyqu33n12.webp', limited: false },
      { id: 'psyqu33n-013', titleFr: 'Trusting the Process', titleEn: 'Trusting the Process', image: '/images/prints/Psyqu33n13.webp', limited: false },
      { id: 'psyqu33n-014', titleFr: 'Angel', titleEn: 'Angel', image: '/images/prints/Psyqu33n14.webp', limited: false },
      { id: 'psyqu33n-015', titleFr: 'Cutie', titleEn: 'Cutie', image: '/images/prints/Psyqu33n15.webp', limited: false },
      { id: 'psyqu33n-016', titleFr: 'Harley', titleEn: 'Harley', image: '/images/prints/Psyqu33n16.webp', limited: false },
      { id: 'psyqu33n-017', titleFr: 'Mask', titleEn: 'Mask', image: '/images/prints/Psyqu33n17.webp', limited: false },
      { id: 'psyqu33n-018', titleFr: 'Metaverse', titleEn: 'Metaverse', image: '/images/prints/Psyqu33n18.webp', limited: false },
      { id: 'psyqu33n-019', titleFr: 'Psyborg', titleEn: 'Psyborg', image: '/images/prints/Psyqu33n19.webp', limited: false },
      { id: 'psyqu33n-020', titleFr: "Queen d'Asie", titleEn: 'Queen of Asia', image: '/images/prints/Psyqu33n20.webp', limited: false },
      { id: 'psyqu33n-021', titleFr: "Secret d'Egypte", titleEn: 'Secret of Egypt', image: '/images/prints/Psyqu33n21.webp', limited: false },
      { id: 'psyqu33n-022', titleFr: 'The Sun', titleEn: 'The Sun', image: '/images/prints/Psyqu33n22.webp', limited: false },
      { id: 'psyqu33n-023', titleFr: 'The Gaming Queen', titleEn: 'The Gaming Queen', image: '/images/prints/Psyqu33n23.webp', limited: false },
      { id: 'psyqu33n-024', titleFr: 'Vampire', titleEn: 'Vampire', image: '/images/prints/Psyqu33n24.webp', limited: false },
    ],
    sortOrder: 4,
    active: true,
  },
