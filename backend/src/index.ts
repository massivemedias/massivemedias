...
const artistsSeedData = [
  ...
  },
  {
    ...
    prints: [
      ...
      { id: 'psyqu33n-013', titleFr: 'Le Vampire - Recalibrer ses relations', titleEn: 'The Vampire - Recalibrating Relationships', image: '/images/prints/Psyqu33n13.webp', limited: false },
    ],
    sortOrder: 4,
    active: true,
  },
