import{j as e,h as x,Z as p,fy as O,a as I,T as b,I as $,C as Ce,r as R,aI as L,o as U,V as Te,a5 as we,fz as ve,bW as Y,a2 as ee,fA as ke,_ as te,bD as $e,bK as De,bL as Me,cI as Re,bo as Se,aF as Ae,K as Ie,bM as ne,z as B,d2 as Fe,Q as Ee,w as Le,f3 as Oe,bq as Ne,aO as V,fB as Ue,L as oe}from"./strapi-ChTDxfn5.js";import{u as D,g as m,C as J,a as Z,A as Be,b as H,S as Pe,c as Q,d as ie}from"./index-C_6x2Sxj.js";import{d as ze,e as X,D as Ve,f as We,a as Ze,S as He,v as Ke,s as _e,K as qe,P as Ge,c as Je,C as Qe}from"./sortable.esm-CyQ2XXeb.js";import"./index-og44Xbex.js";import"./index-CTU37psc.js";import"./index-BRVyLNfZ.js";const Xe=t=>{let{transform:n}=t;return{...n,x:0}},Ye=x(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,Tt=R.memo(({disabled:t,type:n})=>{const{formatMessage:o}=I(),s=Ee(),r=yt(n),l=o({id:"content-type-builder.form.button.configure-view",defaultMessage:"Configure the view"}),i=()=>{if(t)return!1;const y=jt(n);return s(y),!1},{isLoading:c,allowedActions:f}=Le(r);return c||!f.canConfigureView&&!f.canConfigureLayout?null:e.jsx(Ct,{startIcon:e.jsx(Oe,{}),variant:"tertiary",onClick:i,disabled:t,children:l})}),wt=x(oe.Header)`
  ...
  white-space: nowrap;
`,St=()=>{const{isInDevelopmentMode:t,contentTypes:n,components:o,isLoading:s}=D(),{formatMessage:r}=I(),{trackUsage:l}=ie(),{contentTypeUid:i,componentUid:c}=Ne(),{onOpenModalAddComponentsToDZ:f,onOpenModalAddField:y,onOpenModalEditSchema:k}=Z(),a=i?n[i]:c?o[c]:null;if(s)return null;if(!a){const j=Object.values(n).filter(C=>C.visible===!0&&!C.plugin).map(C=>C.uid).sort();return j.length>0?e.jsx(V,{to:`/plugins/content-type-builder/content-types/${j[0]}`}):e.jsx(V,{to:"/plugins/content-type-builder/content-types/create-content-type"})}if(i&&a.modelType==="contentType"&&a.visible===!1)return e.jsx(V,{to:"/plugins/content-type-builder/content-types/create-content-type",replace:!0});const d="plugin"in a&&a?.plugin!==void 0,u=i?"contentType":"component",T=a?.info?.displayName??"",w=t&&!d,S=j=>{f({dynamicZoneTarget:j,targetUid:a.uid})},M=()=>{if("kind"in a){a?.kind==="collectionType"&&l("willEditNameOfContentType"),a?.kind==="singleType"&&l("willEditNameOfSingleType"),k({modalType:u,forTarget:u,targetUid:a.uid,kind:a?.kind});return}k({modalType:u,forTarget:u,targetUid:a.uid})},F=r({id:m("table.button.no-fields"),defaultMessage:"Add new field"}),A=r({id:m("button.attributes.add.another"),defaultMessage:"Add another field"}),g=a.status==="REMOVED",h=t&&e.jsxs(b,{gap:2,children:[e.jsx(Tt,{type:a,disabled:a.status==="NEW"||g},"link-to-cm-settings-view"),e.jsx(B,{startIcon:e.jsx(te,{}),variant:"tertiary",onClick:M,disabled:!w||g,children:r({id:"app.utils.edit",defaultMessage:"Edit"})}),e.jsx(B,{startIcon:e.jsx(L,{}),variant:"secondary",minWidth:"max-content",onClick:()=>{y({forTarget:u,targetUid:a.uid})},disabled:g,children:a.attributes.length===0?F:A})]});return e.jsxs(e.Fragment,{children:[e.jsx(ne.contentTypeBuilder.Introduction,{children:e.jsx(p,{})}),g&&e.jsx(b,{background:"danger100",justifyContent:"center",padding:4,children:e.jsxs(b,{gap:2,children:[e.jsx(Ue,{fill:"danger600",height:"2rem",width:"2rem"}),e.jsx($,{children:r({id:m("table.warning.deleted"),defaultMessage:"This {kind} has been deleted"},{kind:a.modelType==="contentType"?"Content Type":"Component"})})]})}),e.jsx(wt,{id:"title",primaryAction:h,title:H(T)}),e.jsx(oe.Content,{children:e.jsx(p,{background:"neutral0",shadow:"filterShadow",hasRadius:!0,overflow:"auto",borderColor:"neutral150",children:e.jsx(ue,{type:a,addComponentToDZ:S,isMain:!0})})})]})};export{St as default};
