...
exports.default = strapi_1.factories.createCoreController('api::artist-submission.artist-submission', ({ strapi }) => ({
    async adminList(ctx) {
    ...
    async submit(ctx) {
        const { nomLegal, nomArtiste, adresse, email, telephone, tpsTvq, bio, photoProfilUrl, portfolioUrls, contractAccepted, contractVersion, supabaseUserId, } = ctx.request.body;
        ...
        try {
            ...
            (0, email_1.sendContractSignedEmail)({
                artistName: nomLegal,
                artistEmail: email,
