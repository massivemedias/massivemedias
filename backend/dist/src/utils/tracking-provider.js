...
exports.getTrackingStatus = void 0;
/**
 ...
 */
function mockTracking(trackingNumber, carrier) {
 ...
 */
async function fetchFromProvider(trackingNumber, carrier) {
 ...
 */
async function getTrackingStatus(trackingNumber, carrier) {
