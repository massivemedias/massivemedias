...
exports.sendInvoiceEmail = exports.sendPrivatePrintEmail = exports.sendNewUserNotificationEmail = exports.sendDriveFailureAlert = exports.sendWebhookFailureAlert = exports.sendAutoReplyToProspect = exports.sendNewContactNotificationEmail = exports.sendOrderReadyEmail = exports.sendTrackingEmail = exports.sendNewOrderNotificationEmail = exports.sendArtistSaleNotificationEmail = exports.sendContractSignedEmail = exports.sendOrderConfirmationEmail = exports.sendTestimonialRequestEmail = exports.sendContactReplyEmail = void 0;
...
function buildTrackingLinkBlock(orderRef, customerEmail) {
...
function massiveEmailWrapper(content) {
    return `<!DOCTYPE html>
<html>
...
function getAdminBcc() {
    var _a;
    const bcc = (_a = process.env.ADMIN_BCC_EMAIL) !== null && _a !== void 0 ? _a : 'massivemedias@gmail.com';
    if (!bcc || !bcc.trim())
        return [];
    return [bcc.trim()];
}
...
function buildContactReplyHtml(data) {
...
async function sendContactReplyEmail(data) {
...
function isValidHttpUrl(value) {
    ...
    if (trimmed.startsWith('[') || trimmed.includes('LIEN_GOOGLE_REVIEW'))
        return false;
...
exports.sendTestimonialRequestEmail = sendTestimonialRequestEmail;
// -----------------------------------------------------------
...
function buildContractSignedHtml(data, isForArtist) {
...
async function sendContractSignedEmail(data) {
    const resend = getResend();
    if (!resend) {
...
exports.sendContractSignedEmail = sendContractSignedEmail;
function buildArtistSaleNotificationHtml(data) {
...
async function sendArtistSaleNotificationEmail(data) {
    const resend = getResend();
    if (!resend) {
...
exports.sendArtistSaleNotificationEmail = sendArtistSaleNotificationEmail;
function buildNewOrderNotificationHtml(data) {
...
async function sendNewOrderNotificationEmail(data) {
    const resend = getResend();
    if (!resend)
        return false;
    const sender = getSender();
...
exports.sendNewOrderNotificationEmail = sendNewOrderNotificationEmail;
...
async function sendTrackingEmail(data) {
    const resend = getResend();
    if (!resend) {
...
exports.sendTrackingEmail = sendTrackingEmail;
function buildOrderReadyEmailHtml(data) {
...
async function sendOrderReadyEmail(data) {
    const resend = getResend();
    if (!resend) {
...
exports.sendOrderReadyEmail = sendOrderReadyEmail;
...
// -----------------------------------------------------------
async function sendWebhookFailureAlert(info) {
    const resend = getResend();
    if (!resend) {
...
exports.sendWebhookFailureAlert = sendWebhookFailureAlert;
...
// -----------------------------------------------------------
async function sendDriveFailureAlert(info) {
    const resend = getResend();
    if (!resend) {
...
exports.sendDriveFailureAlert = sendDriveFailureAlert;
// -----------------------------------------------------------
// Email de notification de nouvelle inscription
// -----------------------------------------------------------
async function sendNewUserNotificationEmail(userName, userEmail, provider) {
    const resend = getResend();
    if (!resend)
        return false;
    const sender = getSender();
...
exports.sendNewUserNotificationEmail = sendNewUserNotificationEmail;
function buildPrivatePrintHtml(data) {
...
function buildPrivatePrintAdminHtml(data) {
...
function buildPrivatePrintText(data) {
    const base = typeof data.basePrice === 'number' ? data.basePrice : data.price;
    const allowCustom = !!data.allowCustomPrice;
...
async function sendPrivatePrintEmail(data) {
    const resend = getResend();
    if (!resend) {
        console.warn('[email] Resend non configure');
        return false;
    }
    const adminEmail = process.env.ADMIN_EMAIL || 'massivemedias@gmail.com';
    let clientOk = false;
