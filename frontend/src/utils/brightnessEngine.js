...
const PALETTE_9 = {
  ...
  '--logo-main': '#6300B8',
  '--logo-accent': '#FF00AE',
  '--aurora-glow1': 'rgba(99, 0, 184, 0.03)',
  '--aurora-glow2': 'rgba(99, 0, 184, 0.02)',
  '--aurora-glow3': 'rgba(0, 0, 0, 0)',
  ...
  '--bg-card': '#FFFFFF',
  '--bg-card-solid': '#FFFFFF',
  '--bg-card-border': 'rgba(99, 0, 184, 0.08)',
  '--bg-header': 'rgba(250, 250, 255, 0.96)',
  '--bg-footer': '#1E1A2E',
  '--bg-input': 'rgba(99, 0, 184, 0.02)',
  '--bg-input-border': 'rgba(99, 0, 184, 0.15)',
  '--bg-glass': 'rgba(99, 0, 184, 0.03)',
  '--bg-glass-alt': 'rgba(99, 0, 184, 0.05)',
  '--bg-table-head': '#F4F2F7',
  '--bg-select-option': '#FFFFFF',
  '--icon-bg': 'rgba(99, 0, 184, 0.06)',
  '--header-dropdown-bg': '#FFFFFF',
  '--header-item-hover': '#F4F2F7',
  '--header-border': 'rgba(99, 0, 184, 0.08)',
  '--nav-text': '#3A3550',
  '--nav-text-hover': '#1E1A2E',
  '--outline-border': 'rgba(99, 0, 184, 0.18)',
  '--outline-hover-bg': 'rgba(99, 0, 184, 0.04)',
  '--outline-hover-border': 'rgba(99, 0, 184, 0.35)',
  '--table-border': 'rgba(99, 0, 184, 0.06)',
  '--table-hover': 'rgba(99, 0, 184, 0.03)',
  '--scrollbar-track': '#F4F2F7',
  '--scrollbar-thumb': '#D8D0E8',
  '--scrollbar-thumb-hover': '#6300B8',
  '--pattern-dot': 'transparent',
  '--overlay-cta': 'rgba(30, 26, 46, 0.88)',
  '--icon-glass': 'rgba(99, 0, 184, 0.06)',
  '--toggle-border': 'rgba(99, 0, 184, 0.18)',
  '--toggle-text': '#3A3550',
  '--toggle-hover-border': 'rgba(99, 0, 184, 0.35)',
  '--footer-border': 'rgba(255, 255, 255, 0.08)',
  '--footer-text': '#FFFFFF',
  '--footer-text-muted': 'rgba(255, 255, 255, 0.5)',
  '--btn-outline-text': '#1E1A2E',
  '--btn-primary-bg': '#6300B8',
  '--btn-primary-hover-bg': '#5000A0',
  '--btn-primary-hover-text': '#FFFFFF',
  ...
  '--filter-hover-text': '#FFFFFF',
  '--card-shadow': '0 1px 6px rgba(99, 0, 184, 0.06)',
  '--header-dropdown-shadow': '0 4px 20px rgba(99, 0, 184, 0.10)',
  '--header-shadow': '0 1px 4px rgba(99, 0, 184, 0.06)',
...
export const THEME_ACCENTS = [
  ...
  '#D4A574', '#C4725A', '#FF6B35', '#38B2AC', '#C07830', '#6300B8'
];
