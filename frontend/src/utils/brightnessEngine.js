...
// 9 - Light (elegant blanc + accent violet Massive)
const PALETTE_9 = {
  '--color-purple-dark': '#FFFFFF',
  '--color-purple-mid': '#F4F2F7',
  '--color-purple-main': '#E8E4EF',
  '--color-grey-light': '#3A3550',
  '--color-grey-muted': '#7B7490',
  '--color-heading': '#1E1A2E',
  '--logo-main': '#1E1A2E',
  '--logo-accent': '#7C3AED',
  '--aurora-glow1': 'rgba(124, 58, 237, 0.03)',
  '--aurora-glow2': 'rgba(124, 58, 237, 0.02)',
  '--aurora-glow3': 'rgba(0, 0, 0, 0)',
  '--aurora-bg-start': '#F8F7FC',
  '--aurora-bg-mid': '#FFFFFF',
  '--aurora-bg-end': '#FAFAFF',
  '--bg-body': '#FAFAFF',
  '--bg-card': '#FFFFFF',
  '--bg-card-solid': '#FFFFFF',
  '--bg-card-border': 'rgba(124, 58, 237, 0.08)',
  '--bg-header': 'rgba(250, 250, 255, 0.96)',
  '--bg-footer': '#1E1A2E',
  '--bg-input': 'rgba(124, 58, 237, 0.02)',
  '--bg-input-border': 'rgba(124, 58, 237, 0.15)',
  '--bg-glass': 'rgba(124, 58, 237, 0.03)',
  '--bg-glass-alt': 'rgba(124, 58, 237, 0.05)',
  '--bg-table-head': '#F4F2F7',
  '--bg-select-option': '#FFFFFF',
  '--icon-bg': 'rgba(124, 58, 237, 0.06)',
  '--header-dropdown-bg': '#FFFFFF',
  '--header-item-hover': '#F4F2F7',
  '--header-border': 'rgba(124, 58, 237, 0.08)',
  '--nav-text': '#3A3550',
  '--nav-text-hover': '#1E1A2E',
  '--outline-border': 'rgba(124, 58, 237, 0.18)',
  '--outline-hover-bg': 'rgba(124, 58, 237, 0.04)',
  '--outline-hover-border': 'rgba(124, 58, 237, 0.35)',
  '--table-border': 'rgba(124, 58, 237, 0.06)',
  '--table-hover': 'rgba(124, 58, 237, 0.03)',
  '--scrollbar-track': '#F4F2F7',
  '--scrollbar-thumb': '#D8D0E8',
  '--scrollbar-thumb-hover': '#7C3AED',
  '--pattern-dot': 'transparent',
  '--overlay-cta': 'rgba(30, 26, 46, 0.88)',
  '--icon-glass': 'rgba(124, 58, 237, 0.06)',
  '--toggle-border': 'rgba(124, 58, 237, 0.18)',
  '--toggle-text': '#3A3550',
  '--toggle-hover-border': 'rgba(124, 58, 237, 0.35)',
  '--footer-border': 'rgba(255, 255, 255, 0.08)',
  '--footer-text': '#FFFFFF',
  '--footer-text-muted': 'rgba(255, 255, 255, 0.5)',
  '--btn-outline-text': '#1E1A2E',
  '--btn-primary-bg': '#7C3AED',
  '--btn-primary-hover-bg': '#6D28D9',
  '--btn-primary-hover-text': '#FFFFFF',
  '--btn-primary-shadow': 'rgba(124, 58, 237, 0.25)',
  '--accent-color': '#7C3AED',
  '--active-tab-bg': '#7C3AED',
  '--filter-active-bg': '#7C3AED',
  '--filter-hover-bg': '#6D28D9',
  '--filter-hover-text': '#FFFFFF',
  '--card-shadow': '0 1px 6px rgba(124, 58, 237, 0.06)',
  '--header-dropdown-shadow': '0 4px 20px rgba(124, 58, 237, 0.10)',
  '--header-shadow': '0 1px 4px rgba(124, 58, 237, 0.06)',
  '--hero-gradient': 'linear-gradient(180deg, rgba(250,250,255,0.85) 0%, rgba(244,242,247,0.96) 100%)',
  '--highlight-bg': '#F4F2F7',
  '--cta-bg': '#F4F2F7',
  '--cta-text-bg': '#F4F2F7',
  '--space-overlay': 'linear-gradient(180deg, transparent 0%, rgba(250,250,255,0.95) 100%)',
  '--icon-glass-blur': 'blur(8px)',
};
...
export const THEME_COLORS = [
  '#2C0056', '#0C1E3A', '#0D3040', '#0B2818', '#2E0A1A',
...
export const THEME_ACCENTS = [
  ...
  '#D4A574', '#C4725A', '#FF6B35', '#38B2AC', '#C07830', '#7C3AED'
];
