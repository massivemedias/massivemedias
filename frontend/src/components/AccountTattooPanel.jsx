...
const STATUS_LABELS = {
  demandee: { fr: 'Demandee', en: 'Requested', color: 'text-blue-500' },
  confirmee: { fr: 'Confirmee', en: 'Confirmed', color: 'text-green-500' },
  planifiee: { fr: 'Planifiee', en: 'Scheduled', color: 'text-accent' },
  realisee: { fr: 'Realisee', en: 'Completed', color: 'text-gray-400' },
  annulee: { fr: 'Annulee', en: 'Cancelled', color: 'text-red-500' },
};
