        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-sm footer-muted">
              {(content && bl(content, 'footerStudioDesc', lang)) || t('footer.studioDesc')}<br />
              {(content && bl(content, 'footerLocation', lang)) || t('footer.location')}
            </p>
          </div>
            ...
            <div className="flex gap-4 mt-6">
              {cmsSocialLinks
                ? cmsSocialLinks.map((social, index) => {
                    ...
                    const icon = socialIconMap[platform] || socialIconMap.instagram;
                    const hoverColor = socialColorMap[platform] || 'hover:bg-accent';
                    return (
                      <a
                        key={index}
                        href={social.url}
                        ...
                        className={`p-2 rounded-full text-white ${hoverColor} transition-all duration-300 social-icon-btn`}
