const translations = {
  fr: {
    ...
    tarifsPage: {
      ...
      fineArt: {
        ...
        subtitle: 'Impression professionnelle grand format · Papiers fine art premium · Qualité galerie',
      ...
      stickers: {
        ...
        table2Headers: ['Quantité', 'Prix', 'Prix/feuille'],
      },
      design: {
        title: 'Design Graphique',
        subtitle: 'Suite Adobe Creative Cloud · Photoshop, Illustrator, InDesign, Lightroom',
      ...
      web: {
        title: 'Développement Web',
        subtitle: 'React, CMS headless, WordPress, Shopify · Sites performants, sécurisés, optimisés SEO',
  ...
  en: {
    ...
    tarifsPage: {
      ...
      fineArt: {
        title: 'Fine Art Printing',
        subtitle: 'Professional large format printing · Premium fine art papers · Gallery quality',
      ...
      stickers: {
        ...
        table2Headers: ['Quantity', 'Price', 'Price/sheet'],
      },
      design: {
        title: 'Graphic Design',
        subtitle: 'Adobe Creative Cloud Suite · Photoshop, Illustrator, InDesign, Lightroom',
      ...
      web: {
        title: 'Web Development',
        subtitle: 'React, headless CMS, WordPress, Shopify · Fast, secure, SEO-optimized sites',
