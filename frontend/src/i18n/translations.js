const translations = {
  fr: {
    ...
    tarifsPage: {
      ...
      fineArt: {
        ...
        subtitle: 'Tirages qualité galerie sur papiers premium, encres pigmentées 12 couleurs',
        note: 'Pick-up gratuit Mile-End · Livraison locale disponible',
        headers: ['Format', 'Sans cadre', 'Avec cadre noir'],
        rows: [
          ['A4 (8×10")', '45$', '75$'],
          ['A3 (12×18")', '55$', '95$'],
          ['A3+ (13×19")', '65$', '110$'],
          ['A2 (18×24")', '95$', '150$'],
          ['24×36" (grand format)', '150$', 'Sur demande'],
        ],
      },
      stickers: {
        title: 'Stickers personnalisés',
        subtitle: 'Vinyle matte, glossy, transparent ou holographique · Design graphique inclus',
    ...
    checkout: {
      ...
      comingSoon: 'Paiement en ligne bientôt disponible',
      comingSoonSub: 'Le système de paiement Stripe est en cours d\'intégration. En attendant, passe ta commande via le formulaire de contact.',
  ...
  en: {
    ...
    tarifsPage: {
      ...
      fineArt: {
        title: 'Fine Art Printing',
        subtitle: 'Gallery-quality prints on premium papers, 12-color pigment inks',
        note: 'Free pick-up Mile-End · Local delivery available',
        headers: ['Format', 'Unframed', 'Black frame'],
        rows: [
          ['A4 (8×10")', '$45', '$75'],
          ['A3 (12×18")', '$55', '$95'],
          ['A3+ (13×19")', '$65', '$110'],
          ['A2 (18×24")', '$95', '$150'],
          ['24×36" (large format)', '$150', 'On request'],
        ],
      },
      stickers: {
        title: 'Custom Stickers',
        subtitle: 'Matte, glossy, clear or holographic vinyl · Graphic design included',
    ...
    checkout: {
      ...
      comingSoonSub: 'Stripe payment integration is being set up. In the meantime, place your order via the contact form.',
