...
const artistsData = {
  'adrift': {
    ...
    prints: [
      ...
      { id: 'adrift-005', titleFr: 'Print V', titleEn: 'Print V', titleEs: 'Print V', image: thumb('/images/prints/Adrift5.webp'), fullImage: img('/images/prints/Adrift5.webp'), limited: false },
      { id: 'adrift-006', titleFr: 'Print VI', titleEn: 'Print VI', titleEs: 'Print VI', image: thumb('/images/prints/Adrift6.webp'), fullImage: img('/images/prints/Adrift6.webp'), limited: false },
      { id: 'adrift-007', titleFr: 'Print VII', titleEn: 'Print VII', titleEs: 'Print VII', image: thumb('/images/prints/Adrift7.webp'), fullImage: img('/images/prints/Adrift7.webp'), limited: false },
      { id: 'adrift-008', titleFr: 'Print VIII', titleEn: 'Print VIII', titleEs: 'Print VIII', image: thumb('/images/prints/Adrift8.webp'), fullImage: img('/images/prints/Adrift8.webp'), limited: false },
      { id: 'adrift-009', titleFr: 'Print IX', titleEn: 'Print IX', titleEs: 'Print IX', image: thumb('/images/prints/Adrift9.webp'), fullImage: img('/images/prints/Adrift9.webp'), limited: false },
      { id: 'adrift-010', titleFr: 'Print X', titleEn: 'Print X', titleEs: 'Print X', image: thumb('/images/prints/Adrift10.webp'), fullImage: img('/images/prints/Adrift10.webp'), limited: false },
      { id: 'adrift-011', titleFr: 'Print XI', titleEn: 'Print XI', titleEs: 'Print XI', image: thumb('/images/prints/Adrift11.webp'), fullImage: img('/images/prints/Adrift11.webp'), limited: false },
      { id: 'adrift-012', titleFr: 'Print XII', titleEn: 'Print XII', titleEs: 'Print XII', image: thumb('/images/prints/Adrift12.webp'), fullImage: img('/images/prints/Adrift12.webp'), limited: false },
      { id: 'adrift-013', titleFr: 'Print XIII', titleEn: 'Print XIII', titleEs: 'Print XIII', image: thumb('/images/prints/Adrift13.webp'), fullImage: img('/images/prints/Adrift13.webp'), limited: false },
      { id: 'adrift-014', titleFr: 'Print XIV', titleEn: 'Print XIV', titleEs: 'Print XIV', image: thumb('/images/prints/Adrift14.webp'), fullImage: img('/images/prints/Adrift14.webp'), limited: false },
      { id: 'adrift-015', titleFr: 'Print XV', titleEn: 'Print XV', titleEs: 'Print XV', image: thumb('/images/prints/Adrift15.webp'), fullImage: img('/images/prints/Adrift15.webp'), limited: false },
      { id: 'adrift-016', titleFr: 'Print XVI', titleEn: 'Print XVI', titleEs: 'Print XVI', image: thumb('/images/prints/Adrift16.webp'), fullImage: img('/images/prints/Adrift16.webp'), limited: false },
    ],
    pricing: {
