...
{ id: 'psyqu33n-012', titleFr: 'Trouver le divin en soi', titleEn: 'Finding the Divine Within', titleEs: 'Encontrar lo divino en uno mismo', image: thumb('/images/prints/Psyqu33n12.webp'), fullImage: img('/images/prints/Psyqu33n12.webp'), limited: false },
  ...
  'cornelia-rose': {
    ...
    prints: [
      ...
      { id: 'cr-003', titleFr: 'Cosmic Compass', titleEn: 'Cosmic Compass', titleEs: 'Cosmic Compass', image: thumb('/images/prints/CorneliaRose3.webp'), fullImage: img('/images/prints/CorneliaRose3.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-004', titleFr: 'Liongate', titleEn: 'Liongate', titleEs: 'Liongate', image: thumb('/images/prints/CorneliaRose4.webp'), fullImage: img('/images/prints/CorneliaRose4.webp'), limited: false, maxFormat: 'a3' },
      ...
      { id: 'cr-007', titleFr: 'Sans titre I', titleEn: 'Untitled I', titleEs: 'Sin titulo I', image: thumb('/images/prints/CorneliaRose7.webp'), fullImage: img('/images/prints/CorneliaRose7.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-008', titleFr: 'Sans titre II', titleEn: 'Untitled II', titleEs: 'Sin titulo II', image: thumb('/images/prints/CorneliaRose8.webp'), fullImage: img('/images/prints/CorneliaRose8.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-009', titleFr: 'Sans titre III', titleEn: 'Untitled III', titleEs: 'Sin titulo III', image: thumb('/images/prints/CorneliaRose9.webp'), fullImage: img('/images/prints/CorneliaRose9.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-010', titleFr: 'Sans titre IV', titleEn: 'Untitled IV', titleEs: 'Sin titulo IV', image: thumb('/images/prints/CorneliaRose10.webp'), fullImage: img('/images/prints/CorneliaRose10.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-011', titleFr: 'Sans titre V', titleEn: 'Untitled V', titleEs: 'Sin titulo V', image: thumb('/images/prints/CorneliaRose11.webp'), fullImage: img('/images/prints/CorneliaRose11.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-012', titleFr: 'Sans titre VI', titleEn: 'Untitled VI', titleEs: 'Sin titulo VI', image: thumb('/images/prints/CorneliaRose12.webp'), fullImage: img('/images/prints/CorneliaRose12.webp'), limited: false, maxFormat: 'a3' },
      { id: 'cr-013', titleFr: 'Sans titre VII', titleEn: 'Untitled VII', titleEs: 'Sin titulo VII', image: thumb('/images/prints/CorneliaRose13.webp'), fullImage: img('/images/prints/CorneliaRose13.webp'), limited: false, maxFormat: 'a3' },
    ],
    pricing: {
      studio: { a4: 35, a3: 50, a3plus: 65, a2: 85 },
      museum: { a4: 75, a3: 120, a3plus: 160, a2: 190 },
