...
const artistsData = {
  ...
  'psyqu33n': {
    ...
    prints: [
      { id: 'psyqu33n-001', titleFr: "Accepter ses parts d'ombres et de lumière", titleEn: 'Embracing Shadow and Light', titleEs: 'Aceptar sus partes de sombra y luz', image: thumb('/images/prints/Psyqu33n1.webp'), fullImage: img('/images/prints/Psyqu33n1.webp'), limited: false },
      ...
      { id: 'psyqu33n-005', titleFr: 'La purge - libérer les émotions stockées', titleEn: 'The Purge - Releasing Stored Emotions', titleEs: 'La purga - liberar las emociones almacenadas', image: thumb('/images/prints/Psyqu33n5.webp'), fullImage: img('/images/prints/Psyqu33n5.webp'), limited: false },
      ...
      { id: 'psyqu33n-008', titleFr: 'The Rebirth', titleEn: 'The Rebirth', titleEs: 'The Rebirth', image: thumb('/images/prints/Psyqu33n8.webp'), fullImage: img('/images/prints/Psyqu33n8.webp'), limited: false },
...
{ id: 'psyqu33n-012', titleFr: 'Trouver le divin en soi', titleEn: 'Finding the Divine Within', titleEs: 'Encontrar lo divino en uno mismo', image: thumb('/images/prints/Psyqu33n12.webp'), fullImage: img('/images/prints/Psyqu33n12.webp'), limited: false },
      ...
      { id: 'psyqu33n-014', titleFr: 'Angel', titleEn: 'Angel', titleEs: 'Angel', image: thumb('/images/prints/Psyqu33n14.webp'), fullImage: img('/images/prints/Psyqu33n14.webp'), limited: false },
      { id: 'psyqu33n-015', titleFr: 'Cutie', titleEn: 'Cutie', titleEs: 'Cutie', image: thumb('/images/prints/Psyqu33n15.webp'), fullImage: img('/images/prints/Psyqu33n15.webp'), limited: false },
      { id: 'psyqu33n-016', titleFr: 'Harley', titleEn: 'Harley', titleEs: 'Harley', image: thumb('/images/prints/Psyqu33n16.webp'), fullImage: img('/images/prints/Psyqu33n16.webp'), limited: false },
      { id: 'psyqu33n-017', titleFr: 'Mask', titleEn: 'Mask', titleEs: 'Mask', image: thumb('/images/prints/Psyqu33n17.webp'), fullImage: img('/images/prints/Psyqu33n17.webp'), limited: false },
      { id: 'psyqu33n-018', titleFr: 'Metaverse', titleEn: 'Metaverse', titleEs: 'Metaverse', image: thumb('/images/prints/Psyqu33n18.webp'), fullImage: img('/images/prints/Psyqu33n18.webp'), limited: false },
      { id: 'psyqu33n-019', titleFr: 'Psyborg', titleEn: 'Psyborg', titleEs: 'Psyborg', image: thumb('/images/prints/Psyqu33n19.webp'), fullImage: img('/images/prints/Psyqu33n19.webp'), limited: false },
      { id: 'psyqu33n-020', titleFr: 'Queen d\'Asie', titleEn: 'Queen of Asia', titleEs: 'Reina de Asia', image: thumb('/images/prints/Psyqu33n20.webp'), fullImage: img('/images/prints/Psyqu33n20.webp'), limited: false },
      { id: 'psyqu33n-021', titleFr: 'Secret d\'Egypte', titleEn: 'Secret of Egypt', titleEs: 'Secreto de Egipto', image: thumb('/images/prints/Psyqu33n21.webp'), fullImage: img('/images/prints/Psyqu33n21.webp'), limited: false },
      { id: 'psyqu33n-022', titleFr: 'The Sun', titleEn: 'The Sun', titleEs: 'El Sol', image: thumb('/images/prints/Psyqu33n22.webp'), fullImage: img('/images/prints/Psyqu33n22.webp'), limited: false },
      { id: 'psyqu33n-023', titleFr: 'The Gaming Queen', titleEn: 'The Gaming Queen', titleEs: 'The Gaming Queen', image: thumb('/images/prints/Psyqu33n23.webp'), fullImage: img('/images/prints/Psyqu33n23.webp'), limited: false },
      { id: 'psyqu33n-024', titleFr: 'Vampire', titleEn: 'Vampire', titleEs: 'Vampiro', image: thumb('/images/prints/Psyqu33n24.webp'), fullImage: img('/images/prints/Psyqu33n24.webp'), limited: false },
    ],
    pricing: {
      studio: { a4: 35, a3: 50, a3plus: 65, a2: 85 },
      museum: { a4: 75, a3: 120, a3plus: 160, a2: 190 },
