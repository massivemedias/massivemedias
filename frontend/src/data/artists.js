...
export const artistFormats = [
  ...
  { id: 'a2', label: 'A2 (18×24")', short: 'A2', descFr: 'Grand Poster', descEn: 'Large Poster', rank: 3, w: 18, h: 24 },
];
...
const artistsData = {
  ...
  'psyqu33n': {
    ...
    stickers: [
      ...
      { id: 'psyqu33n-stk-007', titleFr: 'Medusa See', titleEn: 'Medusa See', titleEs: 'Medusa See', image: img('/images/stickers/Stickers-Psyqu33n7.webp'), fullImage: img('/images/stickers/Stickers-Psyqu33n7.webp') },
      { id: 'psyqu33n-stk-008', titleFr: 'Sticker Queen', titleEn: 'Sticker Queen', titleEs: 'Sticker Queen', image: img('/images/stickers/Stickers-Psyqu33n8.webp'), fullImage: img('/images/stickers/Stickers-Psyqu33n8.webp') },
      { id: 'psyqu33n-stk-009', titleFr: 'Trouver le divin en soi', titleEn: 'Finding the Divine Within', titleEs: 'Encontrar lo divino en uno mismo', image: img('/images/stickers/Stickers-Psyqu33n9.webp'), fullImage: img('/images/stickers/Stickers-Psyqu33n9.webp') },
      { id: 'psyqu33n-stk-010', titleFr: 'Bat', titleEn: 'Bat', titleEs: 'Bat', image: img('/images/stickers/Stickers-Psyqu33n10.webp'), fullImage: img('/images/stickers/Stickers-Psyqu33n10.webp') },
      ...
      { id: 'psyqu33n-stk-012', titleFr: 'New Sticker', titleEn: 'New Sticker', titleEs: 'New Sticker', image: img('/images/stickers/Stickers-Psyqu33n12.webp'), fullImage: img('/images/stickers/Stickers-Psyqu33n12.webp') },
      { id: 'psyqu33n-stk-013', titleFr: 'Psyqu33n Sticker', titleEn: 'Psyqu33n Sticker', titleEs: 'Psyqu33n Sticker', image: img('/images/stickers/Stickers-Psyqu33n13.webp'), fullImage: img('/images/stickers/Stickers-Psyqu33n13.webp') },
    ],
    prints: [
      ...
      { id: 'psyqu33n-013', titleFr: "Queen d'Asie", titleEn: 'Queen of Asia', titleEs: 'Reina de Asia', image: thumb('/images/prints/Psyqu33n13.webp'), fullImage: img('/images/prints/Psyqu33n13.webp'), limited: false },
      { id: 'psyqu33n-014', titleFr: 'Rabbit', titleEn: 'Rabbit', titleEs: 'Conejo', image: thumb('/images/prints/Psyqu33n14.webp'), fullImage: img('/images/prints/Psyqu33n14.webp'), limited: false },
      { id: 'psyqu33n-015', titleFr: 'Renard', titleEn: 'Fox', titleEs: 'Zorro', image: thumb('/images/prints/Psyqu33n15.webp'), fullImage: img('/images/prints/Psyqu33n15.webp'), limited: false },
      { id: 'psyqu33n-016', titleFr: "Secret d'Egypte", titleEn: 'Secret of Egypt', titleEs: 'Secreto de Egipto', image: thumb('/images/prints/Psyqu33n16.webp'), fullImage: img('/images/prints/Psyqu33n16.webp'), limited: false },
      { id: 'psyqu33n-017', titleFr: 'The Sun', titleEn: 'The Sun', titleEs: 'El Sol', image: thumb('/images/prints/Psyqu33n17.webp'), fullImage: img('/images/prints/Psyqu33n17.webp'), limited: false },
      { id: 'psyqu33n-018', titleFr: 'The Gaming Queen', titleEn: 'The Gaming Queen', titleEs: 'The Gaming Queen', image: thumb('/images/prints/Psyqu33n18.webp'), fullImage: img('/images/prints/Psyqu33n18.webp'), limited: false },
      { id: 'psyqu33n-019', titleFr: 'The Rebirth', titleEn: 'The Rebirth', titleEs: 'The Rebirth', image: thumb('/images/prints/Psyqu33n19.webp'), fullImage: img('/images/prints/Psyqu33n19.webp'), limited: false },
      { id: 'psyqu33n-020', titleFr: 'Trouver le divin en soi', titleEn: 'Finding the Divine Within', titleEs: 'Encontrar lo divino en uno mismo', image: thumb('/images/prints/Psyqu33n20.webp'), fullImage: img('/images/prints/Psyqu33n20.webp'), limited: false },
      { id: 'psyqu33n-021', titleFr: 'Trusting the Process', titleEn: 'Trusting the Process', titleEs: 'Confiar en el proceso', image: thumb('/images/prints/Psyqu33n21.webp'), fullImage: img('/images/prints/Psyqu33n21.webp'), limited: false },
