...
Cortados a la forma exacta de tu diseño con nuestro equipo de corte profesional, cada sticker es terminado con laminación para resistir al agua, rayos UV y rayones.`,
    ...
    pricing: {
      title: 'Precios Stickers Personalizados (Die-Cut)',
      note: 'Diseño gráfico incluido en todos los precios',
      tables: [
        {
          subtitle: 'Stickers personalizados die-cut',
          headers: ['Cant.', 'Estándar (Mate/Brillante)', 'Laminado Pro (Ultra-Resistente)', 'Holográfico (Efectos Especiales)'],
          rows: [
    ...
    faq: [
      ...
      { q: '¿Cuál es la cantidad mínima?', a: 'A partir de 10 stickers idénticos. Cuanto mayor sea la cantidad, menor el precio unitario.' },
...
Ideal para merch de artistas, eventos, regalos corporativos o cualquier proyecto personalizado. Camisetas, crewnecks, hoodies, riñoneras con tu logo, tazas, termos y más.`,
    ...
    pricing: {
      ...
      rows: [
        ...
        ['Camiseta (diseño proporcionado)', '5', '$25', '$125'],
        ['Camiseta (diseño proporcionado)', '10', '$22', '$220'],
        ['Camiseta (diseño proporcionado)', '25+', '$20', 'Bajo cotización'],
        ['Crewneck (diseño proporcionado)', '1', '$45', '$45'],
        ['Crewneck (diseño proporcionado)', '5', '$40', '$200'],
        ['Crewneck (diseño proporcionado)', '10', '$35', '$350'],
        ['Hoodie (diseño proporcionado)', '1', '$50', '$50'],
        ['Hoodie (diseño proporcionado)', '5', '$45', '$225'],
        ['Hoodie (diseño proporcionado)', '10', '$40', '$400'],
        ['Riñonera con logo', '1', '$80', '$80'],
        ['Riñonera con logo', '5', '$70', '$350'],
        ['Riñonera con logo', '10', '$60', '$600'],
      ],
    },
    gallery: [
...
Más de 15 años de experiencia en desarrollo web. El fundador de Massive Medias es programador-analista de formación. Utilizamos las tecnologías web más modernas para crear sitios rápidos, seguros y bien posicionados.`,
    highlights: [
