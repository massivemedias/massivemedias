 ...
 *
 * Ordre STRICT du menu (demande proprietaire, avril 2026 - v2) :
 *   1. Dashboard         (vue d'ensemble)
 *   2. Messages          (priorites relation client/artiste)
 *   3. Commandes         (workflow vente principal)
 *   4. Artistes (God)    (mutations directes + finances commissions)
 *   5. Utilisateurs      (gestion comptes)
 *   6. ai.massive        (outils IA internes)
 *   7. Notes             (pense-betes admin)
 *   8. Inventaire        (stock)
