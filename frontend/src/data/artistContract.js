...
export const ARTIST_FAQ = {
  ...
  es: [
    { q: "Puedo pedir impresiones o stickers de mis obras para mi?", a: "Si! Tienes un descuento del 25% sobre el precio cliente para tus prints y stickers. Por ejemplo, un print Museo A3 a 120$ te cuesta 90$, y un pack de 100 stickers a 85$ te cuesta 63.75$. Los gastos de envio aplican normalmente, o puedes recoger gratis en el estudio Mile-End. Para prints: uso personal, portafolio o exposicion, reventa prohibida. Los stickers son libres de distribucion (eventos, promo, etc.)." },
