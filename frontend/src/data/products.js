...
// FINITIONS-V2 (juin 2026) : 3 groupes de prix (matte / intermediate / fx).
// Ordre d'affichage du menu : Sans finition, Clear, Matte, Vinyle Lustre, etc.
// L'id `matte` est CONSERVE pour "Sans finition" (commandes passees + grille
// matte inchangee). Le nouveau "Matte" (finition pro laminee) prend l'id
// `matte-pro` pour eviter la collision. Le mapping id -> grille de prix vit
// dans pricingData.js (STICKER_FX_FINISHES / INTERMEDIATE_FINISHES) et sa
// copie backend pricing-config.ts.
export const stickerFinishes = [
  { id: 'matte', labelFr: 'Sans finition', labelEn: 'No finish', labelEs: 'Sin acabado', descFr: 'Vinyle imprime, sans laminage', descEn: 'Printed vinyl, no lamination', descEs: 'Vinilo impreso, sin laminado' },
  ...
  { id: 'matte-pro', labelFr: 'Matte', labelEn: 'Matte', labelEs: 'Mate', descFr: 'Lamination mate pro, fini doux sans reflets', descEn: 'Pro matte lamination, soft no-shine finish', descEs: 'Laminado mate pro, acabado suave sin reflejos' },
...
export const stickerHighlights = {
  fr: [
    ...
    'Tarification 3 paliers de taille (Standard / Médium / Large)',
  ...
  en: [
    ...
    '3-tier size-based pricing (Standard / Medium / Large)',
  ...
  es: [
    ...
    'Precios en 3 niveles según el tamaño (Standard / Medium / Large)',
...
export const stickerFaq = {
  fr: [
    { q: 'Quels fichiers dois-je fournir?', a: 'Un fichier vectoriel (AI, SVG, PDF) ou un PNG haute résolution (300 DPI minimum) avec fond transparent. Si vous n\'avez pas de fichier prêt, on offre un service de design graphique facturé à part - nous contacter pour devis.' },
  ...
  en: [
    { q: 'What files should I provide?', a: 'A vector file (AI, SVG, PDF) or high-resolution PNG (300 DPI minimum) with transparent background. If you don\'t have a ready file, we offer graphic design as a separate service - contact us for a quote.' },
  ...
  es: [
    { q: '¿Qué archivos debo proporcionar?', a: 'Un archivo vectorial (AI, SVG, PDF) o un PNG de alta resolución (300 DPI mínimo) con fondo transparente. Si no tienes un archivo listo, ofrecemos diseño gráfico como servicio aparte - contáctanos para cotización.' },
...
export const flyerFaq = {
  fr: [
    ...
    { q: 'La livraison est-elle disponible?', a: 'Pick-up gratuit au Plateau Mont-Royal sur rendez-vous uniquement. Livraison locale disponible à Montréal. Idéal pour les événements du Plateau Mont-Royal et alentours.' },
  ],
  en: [
    ...
    { q: 'Is delivery available?', a: 'Free pick-up in Plateau Mont-Royal by appointment only. Local delivery available in Montreal. Ideal for Plateau Mont-Royal and nearby events.' },
  ],
  es: [
    ...
    { q: '¿Hay entrega disponible?', a: 'Recogida gratuita en Plateau Mont-Royal con cita previa. Entrega local disponible en Montreal. Ideal para eventos del Plateau Mont-Royal y alrededores.' },
  ],
};
...
export const designFaq = {
  fr: [
    ...
    { q: 'Le design de stickers est-il inclus dans la production?', a: 'Non - le client fournit son fichier prêt à imprimer pour la production sticker. Le service de design graphique (création de visuels stickers, retouches, adaptations) est facturé à part : nous contacter pour devis.' },
  ...
  en: [
    ...
    { q: 'Is sticker design included in production?', a: 'No - the client provides their print-ready file for sticker production. Graphic design service (sticker visual creation, retouching, adaptations) is billed separately: contact us for a quote.' },
  ...
  es: [
    ...
    { q: '¿El diseño de stickers está incluido en la producción?', a: 'No - el cliente provee su archivo listo para imprimir para la producción de stickers. El servicio de diseño gráfico (creación de visuales, retoques, adaptaciones) se factura aparte: contáctanos para cotización.' },
