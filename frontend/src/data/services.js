...
Idéal pour le merch d'artiste, les événements, les cadeaux corporatifs ou tout projet personnalisé. T-shirts, crewnecks, hoodies, sacs bananes avec ton logo, mugs, thermos et plus encore.`,
    ...
    pricing: {
      ...
      rows: [
        ['T-shirt (design fourni)', '1', '30$', '30$'],
        ['T-shirt (design fourni)', '5', '25$', '125$'],
        ['T-shirt (design fourni)', '10', '22$', '220$'],
        ['T-shirt (design fourni)', '25+', '20$', 'Sur soumission'],
        ['Crewneck (design fourni)', '1', '45$', '45$'],
        ['Crewneck (design fourni)', '5', '40$', '200$'],
        ['Crewneck (design fourni)', '10', '35$', '350$'],
        ['Hoodie (design fourni)', '1', '50$', '50$'],
        ['Hoodie (design fourni)', '5', '45$', '225$'],
        ['Hoodie (design fourni)', '10', '40$', '400$'],
        ['Sac banane avec logo', '1', '80$', '80$'],
        ['Sac banane avec logo', '5', '70$', '350$'],
        ['Sac banane avec logo', '10', '60$', '600$'],
      ],
    },
    gallery: [
    ...
    seo: {
      ...
      description: 'T-shirts, crewnecks, hoodies, sacs bananes, mugs en sublimation. Merch d\'artiste sur mesure. Production locale Montréal.',
    },
  },
...
Nous travaillons avec Adobe Illustrator, Figma et Photoshop pour créer des visuels percutants et cohérents avec ta marque.`,
    ...
    seo: {
      ...
      description: 'Logos, identités visuelles, affiches, pochettes album. Design graphique professionnel à Montréal.',
    },
  },
...
15+ années d'expérience en développement web. Le fondateur de Massive Medias est programmeur-analyste de formation. Nous travaillons avec les technologies web les plus modernes pour créer des sites rapides, sécurisés et bien référencés.`,
    highlights: [
    ...
    seo: {
      ...
      description: 'Sites web, e-commerce, SEO et référencement. Développement web moderne et performant à Montréal. 15+ ans d\'expérience.',
    },
  },
};
