  ...
  return (
    <div className="space-y-6">
      ...
      {(privateSalesLoading || privateSales.length > 0) && (
        <div className="mt-8 rounded-xl card-bg shadow-lg shadow-black/20 p-4 md:p-5 border border-purple-500/20">
          ...
          <p className="text-[10px] text-grey-muted mt-3">
            {tx({
              fr: 'Quand le client paye, la vente apparaitra dans la liste des commandes ci-dessus. Clique sur l\'icone avion pour renvoyer le courriel, sur la poubelle pour annuler la demande.',
              en: 'When the client pays, the sale will appear in the orders list above. Click the plane icon to resend the email, the trash to cancel the request.',
              es: 'Cuando el cliente pague, la venta aparecera en la lista de pedidos arriba. Click en el avion para reenviar correo, papelera para cancelar.',
            })}
          </p>
        </div>
      )}
