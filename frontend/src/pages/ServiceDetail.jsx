...
const SLUG_SEO_ENRICHMENT = {
  stickers: {
    ...
    keywords: [
      ...
      'die-cut stickers Plateau Mont-Royal',
  ...
  design: {
    ...
    keywords: [
      ...
      'studio graphique Plateau Mont-Royal',
  ...
  return (
    <>
      ...
      <div className="section-container max-w-6xl mx-auto">
        ...
        {/* GALLERY-DYNAMIQUE-PRINTS (8 mai 2026) : pour la page /services/prints,
            on remplace la gallery statique par ArtistPortfolioGrid qui pioche
            8 oeuvres aleatoires des artistes Massive Medias avec rendu cadre
            Fine Art noir/blanc alterne. Les autres services conservent leur
            gallery statique inchangee. */}
        {(service.slug === 'prints' || (service.gallery && service.gallery.length > 0)) && (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
                ...
                {service.gallery.map((image, index) => {
                  ...
                  >
                    ...
                    <div className="absolute inset-0 transition-colors duration-300 flex items-center justify-center">
                      <div className="md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 bg-black/30 backdrop-blur-sm rounded-full p-3">
