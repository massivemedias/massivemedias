...
function ArtisteDetail({ subdomainSlug }) {
  ...
  const faqItems = tx({
    fr: [
      ...
      { q: 'Quelle est la différence entre Studio et Musée?', a: TIER_EXPLAINER_LONG_FLAT.fr },
      { q: 'Puis-je récupérer sur place?', a: 'Oui! Pick-up gratuit au Plateau Mont-Royal (Montréal), adresse exacte communiquée au rendez-vous. Livraison locale aussi disponible.' },
    ...
    en: [
      ...
      { q: 'What\'s the difference between Studio and Museum?', a: TIER_EXPLAINER_LONG_FLAT.en },
      { q: 'Can I pick up in person?', a: 'Yes! Free pick-up in Plateau Mont-Royal (Montreal), exact address shared when booking. Local delivery also available.' },
    ...
    es: [
      ...
      { q: 'Cual es la diferencia entre Studio y Museo?', a: TIER_EXPLAINER_LONG_FLAT.es },
      { q: 'Puedo recoger en persona?', a: 'Si! Recogida gratuita en Plateau Mont-Royal (Montreal), direccion exacta al reservar. Envio local tambien disponible.' },
