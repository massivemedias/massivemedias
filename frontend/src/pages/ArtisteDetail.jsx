...
function ArtisteDetail({ subdomainSlug }) {
  ...
  const faqItems = tx({
    ...
    en: [
      ...
      { q: 'Can I pick up in person?', a: 'Yes! Free pick-up in the Plateau (5338 rue Marquette, Montreal). Local delivery also available.' },
    ...
    es: [
      ...
      { q: 'Puedo recoger en persona?', a: 'Si! Recogida gratuita en el Plateau (5338 rue Marquette, Montreal). Envio local tambien disponible.' },
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                transition={{ duration: 0.3 }}
                className={`relative watermark-lightbox${isSticker ? ' watermark-lightbox-sticker' : ''} rounded-lg overflow-hidden`}
