...
const fallbackItems = [
  {
    ...
    startingPrice: 30,
    hasCart: true,
    image: thumb('/images/realisations/stickers/Stickers-Cosmo.webp'),
  },
  {
    slug: 'fine-art',
    serviceKey: 'prints',
    startingPrice: 16,
    hasCart: true,
    image: thumb('/images/realisations/prints/FineArt1.webp'),
  },
  {
    slug: 'sublimation',
    serviceKey: 'merch',
    startingPrice: 30,
    hasCart: true,
    image: thumb('/images/realisations/textile/Textile1.webp'),
  },
  {
    slug: 'flyers',
    serviceKey: 'prints',
    startingPrice: 40,
    hasCart: true,
    image: thumb('/images/realisations/flyers/discodyssee.webp'),
  },
  {
    slug: 'design',
    serviceKey: 'design',
