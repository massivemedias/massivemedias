...
import {
  ...
  LayoutDashboard, BookOpen, CalendarDays, Image, MessageSquare, Bot, Tag, StickyNote,
} from 'lucide-react';
...
function Account() {
  ...
  const getStatusLabel = (status) => {
    const labels = {
      ...
      ready: tx({ fr: 'Prêt à ramasser', en: 'Ready for pickup', es: 'Listo para recoger' }),
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        ...
                        {
                          icon: Clock,
                          value: ordersLoading ? '-' : orders.filter(o => ['pending', 'processing', 'paid', 'ready'].includes(o.status)).length,
                        ...
                        <div key={i} className="rounded-xl p-4 card-bg text-center">
