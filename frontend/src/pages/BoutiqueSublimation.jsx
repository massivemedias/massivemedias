...
function BoutiqueSublimation() {
  ...
  return (
    <BoutiqueProductLayout
      ...
      metaDescription={{
        fr: 'Sublimation textile à Montréal. T-shirts, hoodies, crewnecks, mugs, tote bags. Impression all-over permanente. Merch d\'artiste et corporatif. À partir d\'1 unité. Production locale Plateau Mont-Royal.',
        en: 'Textile sublimation in Montreal. T-shirts, hoodies, crewnecks, mugs, tote bags. Permanent all-over printing. Artist and corporate merch. From 1 unit. Local production Plateau Mont-Royal.',
